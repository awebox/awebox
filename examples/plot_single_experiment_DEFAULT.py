...
# %% Load Data
filepath = '_export/toPlot/20250309_1351_AWE_SAM_N10_d4.npz'
...
for figure_type in ['SAM', 'REC', 'MPC']:
    ...
    if figure_type == 'SAM':
        ax.plot3D(Q10_SAM[0], Q10_SAM[1], Q10_SAM[2], 'C0--', alpha=1)



    if figure_type == 'SAM':
        for region_index, color in zip(np.arange(0, data_SAM['d'] + 1), [f'C{i}' for i in range(20)]):
