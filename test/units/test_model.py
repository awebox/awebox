...
def test_drag_mode_model():
    ...
    lb = trial_options['model']['system_bounds']['u']['dkappa'][0]/trial_options['model']['scaling']['xd']['kappa']
    ub = trial_options['model']['system_bounds']['u']['dkappa'][1]/trial_options['model']['scaling']['xd']['kappa']
    ...
    # test scaling
    assert(model.scaling['xd']['kappa21'] == trial_options['model']['scaling']['xd']['kappa'])
    assert(model.scaling['xd']['kappa31'] == trial_options['model']['scaling']['xd']['kappa'])
    assert(model.scaling['u']['dkappa21'] == trial_options['model']['scaling']['xd']['kappa'])
    assert(model.scaling['u']['dkappa21'] == trial_options['model']['scaling']['xd']['kappa'])
