...
def test_drag_mode_model():
    ...
    assert(model.variable_bounds['xd']['dl_t']['ub'] == 0.0)
    assert(model.variable_bounds['xd']['dl_t']['lb'] == 0.0)
    assert(model.variable_bounds['xd']['ddl_t']['ub'] == 0.0)
    assert(model.variable_bounds['xd']['ddl_t']['lb'] == 0.0)
