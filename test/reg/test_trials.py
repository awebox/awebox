...
def make_basic_health_variant(base_options):
    ...
    basic_health_options['solver.max_iter'] = 200
...
def generate_options_dict():
    ...
    single_kite_options['solver.cost_factor.power'] = 1e5
    ...
    dual_kite_options['solver.cost_factor.power'] = 1e6
    dual_kite_options['solver.initialization.cone_deg'] = 40.
    ...
    dual_kite_6_dof_options['solver.cost_factor.power'] = 1e5
