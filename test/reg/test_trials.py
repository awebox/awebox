...
def generate_options_dict():
    ...
    single_kite_options['solver.weights.q'] = 1e1 #1.e1
    ...
    single_kite_options['solver.cost_factor.power'] = 1e7 #7 #2
    ...
    basic_health_options['solver.health_check.when'] = 'always' #'failure_or_final'
