...
from . import biot_savart as biot_savart
...
def collect_vortex_outputs(model_options, atmos, wind, variables, outputs, parameters, architecture):
    ...
    for kite in kite_nodes:
        outputs['vortex']['u_ind_vortex' + str(kite)] = biot_savart.get_induced_velocity_at_kite(model_options, wind, variables, architecture, kite)
        outputs['vortex']['local_a' + str(kite)] = biot_savart.get_induction_factor_at_kite(model_options, wind, variables, architecture, kite)
