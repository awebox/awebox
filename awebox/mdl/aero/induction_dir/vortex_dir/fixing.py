...
def get_fixing_constraints(options, g_list, g_bounds, V, Outputs, model):
    ...
    print_op.warn_about_temporary_funcationality_removal(editor='rachel', location='vortex.fixing.get_fixing_constraints')
...
def get_placeholder_fixing_constraints(options, variables, model):
    ...
    print_op.warn_about_temporary_funcationality_removal(location='fixing_sdfsdflk')
