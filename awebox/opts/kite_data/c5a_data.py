...
def battery_model_parameters(coeff_max, coeff_min):
    ...
    battery_model['c_dl'] = (battery_model['max_flap_defl'] - battery_model['min_flap_defl']) / (
                coeff_min[0] - coeff_max[0])
    battery_model['c_dphi'] = (battery_model['max_flap_defl'] - battery_model['min_flap_defl']) / (
                coeff_min[1] - coeff_max[1])
...
#
#     # only for plotting
#     geometry['length'] = 75.31  # only for plotting
#     geometry['height'] = 19.84  # only for plotting
#     geometry['c_root'] = 1.4 * geometry['c_ref']
#     geometry['c_tip'] = 2. * geometry['c_ref'] - geometry['c_root']
#
#     geometry['fuselage'] = True
