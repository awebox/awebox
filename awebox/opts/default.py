...
def set_default_options(default_user_options, help_options):
    ...
    default_options_tree = [
        ...
        ('model', 'aero', 'vortex',     'ratio_circulation_max_estimate_to_scaling_estimate', 6, ('ratio between the estimated maximum circulation and that scaling estimate, only used for drawing', None), 'x'),
