...
def set_default_options(default_user_options, help_options):
    ...
    default_options_tree = [
        ...
        ('model', 'aero', 'vortex',     'degree_of_induced_velocity_lifting',   2,              ('how best to embed the biot-savart induced velocity variables where 1: only the induced velocity at each kite is lifted; 2: the induced velocities from all of the elements at each kite are lifted; 3: the numerator and denominator components of the induced velocity, from all elements on all kites, are lifted', [1, 2, 3]), 'x'),
        ...
        ('solver',   'cost_factor',     None,   'power',                 1e5,       ('factor used in generating the power cost [-]', None), 'x'),

        ('solver',  'weights',      None,   'q',        1e0,       ('optimization weight for all q variables [-]', None), 'x'),
        ('solver',  'weights',      None,   'dq',       1e0,       ('optimization weight for all dq variables [-]', None), 'x'),
        ('solver',  'weights',      None,   'ddq',      1e0,        ('optimization weight for all ddq variables [-]', None), 's'),
        ('solver',  'weights',      None,   'l_t',      1e-5,       ('optimization weight for all l_t variables [-]', None), 'x'),
        ('solver',  'weights',      None,   'dl_t',     1e-3,       ('optimization weight for all dl_t variables [-]', None), 'x'),
        ('solver',  'weights',      None,   'ddl_t',    1e-1,        ('optimization weight for all ddl_t variables [-]', None), 'x'),
        ('solver',  'weights',      None,   'dddl_t',   1e-1,        ('optimization weight for all ddl_t variables [-]', None), 'x'),
        ('solver',  'weights',      None,   'l_s',      1e0,        ('optimization weight for the l_s variable [-]', None), 's'),
        ('solver',  'weights',      None,   'r',        1e0,        ('optimization weight for all r variables [-]', None), 'x'),
        ...
        ('solver',  'weights',      None,   'vortex',   1e-10,      ('optimization weight for all vortex variables [-]', None), 'x'),
        ('solver',  'weights',      None,   'actuator', 1e-10,      ('optimization weight for all actuator support variables [-]', None), 'x'),
        ...
        ('solver',  'cost',             'tracking',             0,  1e0,       ('starting cost for tracking', None),'s'),
        ('solver',  'cost',             'u_regularisation',     0,  1e-3,       ('starting cost for u_regularisation', None),'s'),
        ('solver',  'cost',             'xdot_regularisation', 0,   1e-8,       ('starting cost for xdot regularisation', None),'s'),
        ('solver',  'cost',             'theta_regularisation', 0,  1e1,       ('starting cost for theta', None), 's'),
        ...
        ('solver',  'cost',             'fictitious',       0,      1e0,        ('starting cost for fictitious', None),'s'),
