...
def set_default_options(default_user_options, help_options):
    ...
    default_options_tree = [
        ...
        ('model', 'aero', 'vortex',     'ratio_circulation_max_estimate_to_scaling_estimate', 2.5, ('ratio between the estimated maximum circulation and that scaling estimate, only used for drawing', None), 'x'),
        ...
        ('model', 'aero', 'vortex',     'wu_ind_scaling_method',                'infty_full',   ('how to scale the computed induced velocity variables wu_ind: the reference velocity, the reference velocity with an actuator-motivated discount, the freestream velocity, the freestream velocity discounted', ['ref_full', 'ref_betz', 'infty_full', 'infty_betz']), 'x'),
        ...
        ('model',  'system_bounds', 'x',          'dq',           [np.array([-cas.inf, -cas.inf, -cas.inf]), np.array([cas.inf, cas.inf, cas.inf])],  ('kite velocity bounds [m/s]', None), 'x'),
        ...
        ('solver',  'initialization', None, 'inclination_deg',      40.,        ('initial tether inclination angle [deg]. for single kite simulations, should be larger than the cone angle', None),'x'),       ('solver',  'initialization', None, 'min_rel_radius',       2.,         ('minimum allowed radius to span ratio allowed in initial guess [-]', None), 'x'),
