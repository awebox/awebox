...
def set_default_options(default_user_options, help_options):
    ...
    default_options_tree = [
        ...
        ('solver',  'initialization', None, 'inclination_deg',      30.,        ('initial tether inclination angle [deg]. for single kite simulations, should be larger than the cone angle', None),'x'),
        ...
        ('quality', 'when',     None, 'final',          False,              ('run a quality-check on all final solutions.', [True, False]),'x'),
        ('quality', 'when',     None, 'final_success',  True,               ('run a quality-check on all converged final solutions. CAUTION: strongly recommended!', [True, False]), 'x'),
